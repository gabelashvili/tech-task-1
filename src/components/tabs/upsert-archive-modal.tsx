...
import { UpsertArchiveSchema } from '@/schemas/tabs';
import { z } from 'zod';
...
const ArchiveModal: FC<ArchiveModalProps> = ({ closeModal, open, levels, editItem }) => {
  ...
  const {
    ...
    reset,
    setValue,
  } = useForm<z.infer<typeof UpsertArchiveSchema>>({
